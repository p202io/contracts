      ...
      function testEtherDrain() {
        ...
        describe('before drain', function() {
          it('depositManager must have correct balance', async function() {
            utils.assertBigNumberEquality(await this.wethToken.balanceOf(this.depositManager.address), this.amount)
          })
        })
        ...
        describe('after drain', function() {
          ...
          it('depositManager must have correct balance', async function() {
            utils.assertBigNumberEquality(await this.wethToken.balanceOf(this.depositManager.address), this.amount.sub(this.drainAmount))
          })
